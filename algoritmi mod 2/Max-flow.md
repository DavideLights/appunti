...
* $val(f^*) \leq n C$
[[algoritmi mod 2/Apx]]### Parametro $\Delta$
...
Al contrario dato ar[[algoritmi mod 2/Programmazione Dinamica]]co con $f(e)=1$ allora per conservazione del flusso esiste un'altro $f(e')=1$ fino ad arrivare a $t$.
## Image Segmentation
